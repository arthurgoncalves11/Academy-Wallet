...
const NoMovements: React.FC<NoMovementsProps> = ({ customMessage, loading }) => {
  return (
    <div className="flex justify-center items-center flex-col min-h-[52vh] lg:w-[500px] md:w-[370px] 
    gap-4  md:mt-[160px] lg:mt-[110px] 2xl:mt-[190px]">
      ...
      <LoadingWrapper
        ...
        skeletonHeight="35px"
      >
        <p className="font-normal text-sm leading-[0px] text-titleFont md:text-[14px] lg:text-[18px] xl:text-[20px] text-center w-full">
